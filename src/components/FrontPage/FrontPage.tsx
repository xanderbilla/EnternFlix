    ...
    bg-no-repeat bg-fixed bg-center bg-cover">
      <div className="bg-black w-full h-full lg:bg-opacity-50">
        ...
        <div className="text-white h-2/3 flex flex-col items-center justify-center">
          <h1 className="font-extrabold text-6xl md:text-6xl md:text-center">Unlimited movies, TV shows and more
          </h1>
          <p className="mt-4 text-2xl font-medium md:text-center">Watch anywhere. Cancel anytime.</p>
          <div className="mt-6 flex flex-col gap-6">
            <h3 className="text-2xl font-medium md:text-center">Ready to watch? Enter your email to create or restart your membership.</h3>
